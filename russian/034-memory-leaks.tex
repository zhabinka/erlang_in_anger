...
\begin{figure}
  \includegraphics{memory-allocs.png}%
...
\begin{figure}
  \includegraphics{allocation-1-normal.png}%
...
\begin{figure}
  \includegraphics[max height=7cm]{allocation-strategy-1.png}%
  \centering%
%  \caption{Example memory allocated in a specific sub-allocator}%
	\caption{Пример памяти, выделенной некоторым вложенным аллокатором}
...
\begin{figure}
  \includegraphics[max height=7cm]{allocation-strategy-2.png}%
  \centering%
%  \caption{Example memory allocated in a specific sub-allocator}%
	\caption{Пример памяти, выделенной некоторым вложенным аллокатором}
